										   ...
										   OBJECTSTRUCT *lpMonsterObj)
{
	...
	for(int i = 0; i < 25; ++i )
	{
		//fix summon elf monster OLD METHOD (NOT IN USE) 
		/*if(lpObj->m_pUserQuestInfo == NULL)
		{
		continue;
		}*/
...
//Mercenary Guild
void QuestExpProgMng::ItemUseQuest(int aIndex) //MERCENARY FIX
{
	...
	g_Generic_Call(L, "ItemUseQuest", "ii>", aIndex, 20);
